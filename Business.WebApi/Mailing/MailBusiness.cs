...
namespace Business.WebApi.Mailing
{
    public class MailBusiness
    {
        ...
        public BusinessResponse VerifyUser(string verificationLink)
        {
            ...
            var userNameAndPassword = StringCipher.Decrypt(verificationLink, SporComplex.EncyrptingPassword);
        ...
        public Task SendReminderMailAsync(DTO.ApplicationUser user)
        {
        ...
        {
            string encryptedstring = StringCipher.Encrypt(userName + ":" + email, SporComplex.EncyrptingPassword);
            return Statics.GetApiUrl() + "User/Verify/" + encryptedstring;
        }

        private string SetPasswordRemiderLink(string userId, string email)
        {
            string encryptedstring = StringCipher.Encrypt(userId + ":" + email, SporComplex.EncyrptingPassword);
